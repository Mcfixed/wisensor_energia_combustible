...
export const SvgBoyas = () => {
    
    const [hoveredId, setHoveredId] = useState<string|null>(null);
          const getFillColor = (id:string) => (hoveredId === id ? "#61d361" : "#959595");
          //const getStrokeColor = (id:string) => (hoveredId === id ? "#990000" : "#666666");
          // La firma debe incluir el evento, que en React suele ser de tipo React.MouseEvent
const handleClick = (event, id) => {
    // Detiene la propagación para evitar clics "debajo" del popup
    event.stopPropagation(); 
    
    // Llama a tu nueva función helper
    const htmlParaMostrar = `Información de la boya: <strong>${id}</strong><br>`;
...
<g id="Group 5">
<rect id="Rectangle 1" x="40" y="37" width="160" height="160" fill="#D9D9D9" />
<rect id="Rectangle 13" x="222" y="37" width="160" height="160" fill="#D9D9D9"/>
<rect id="Rectangle 9" x="200.5" y="37.5" width="21" height="39" fill={getFillColor("b1")}
            /* stroke={getStrokeColor("jaula6")} */
            onMouseEnter={() => setHoveredId("b1")}
            onMouseLeave={() => setHoveredId(null)}
            className="cursor-pointer"  onClick={(e) => handleClick(e, 'ID-B1')} stroke="red"/>
<rect id="Rectangle 16" x="200.5" y="157.5" width="21" height="39" fill={getFillColor("b4")}
            /* stroke={getStrokeColor("jaula6")} */
            onMouseEnter={() => setHoveredId("b4")}
            onMouseLeave={() => setHoveredId(null)}
            className="cursor-pointer"  onClick={(e) => handleClick(e, 'ID-B2')} stroke="red"/>
<rect id="Rectangle 15" x="200.5" y="117.5" width="21" height="39" fill={getFillColor("b3")}
            /* stroke={getStrokeColor("jaula6")} */
            onMouseEnter={() => setHoveredId("b3")}
            onMouseLeave={() => setHoveredId(null)}
            className="cursor-pointer"  onClick={(e) => handleClick(e, 'ID-B3')} stroke="red"/>
<rect id="Rectangle 14" x="200.5" y="77.5" width="21" height="39" fill={getFillColor("b2")}
            /* stroke={getStrokeColor("jaula6")} */
            onMouseEnter={() => setHoveredId("b2")}
            onMouseLeave={() => setHoveredId(null)}
            className="cursor-pointer"  onClick={(e) => handleClick(e, 'ID-B4')} stroke="red"/>
